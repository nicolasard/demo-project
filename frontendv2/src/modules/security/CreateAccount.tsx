...
<div className="bg-image d-flex align-items-center justify-content-center" style={{height:"100vh"}} >
    ...
    <h3 style={{ paddingTop:"20px", paddingBottom:"10px"}}>Create account</h3>
    <form>
        <div className="row g-2 align-items-center">
          ...
          <div className="mb-3">
            <input type="string" id="full-name" className="form-control" placeholder="Full Name" onChange={handleChangeEmail}/>
          </div>
          <div className="mb-3">
          ...
          <button type="submit" className="btn btn-primary" formAction='#' >Create Account</button>
        </div>
        </form>
